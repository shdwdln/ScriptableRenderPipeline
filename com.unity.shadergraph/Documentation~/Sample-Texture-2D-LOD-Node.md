...
This [Node](Node.md) is useful for sampling a **Texture** in the vertex stage as the [Sample Texture 2D Node](Sample-Texture-2D-Node.md) is unavailable in this stage. 
